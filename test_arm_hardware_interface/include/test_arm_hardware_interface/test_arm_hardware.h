#ifndef ROS_CONTROL__test_arm_hardware_H
#define ROS_CONTROL__test_arm_hardware_H
...
namespace test_arm_hardware_interface//hardware_interface
{
    /// \brief Hardware interface for a robot
    class TestArmHardware : public hardware_interface::RobotHW 
    {
